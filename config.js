...
if (!gg) {
  gg = "917636987434";   // You can Change this number //
}
...
global.mongodb = process.env.MONGODB || "mongodb+srv://dpatar718:<deba1432>@rioyang25.6ehfa.mongodb.net/?retryWrites=true&w=majority&appName=Rioyang25"; // paste your own MongoDB url..
...
global.author = process.env.AUTHOR || "by: 𝓡𝓲𝓸(リオ)🍃🌸";
